...
Memo works with both on-policy and off-policy RL algorithms. Please also refer to https://github.com/Memory-icrl/memo/tree/main for an AMAGO-based implementation of Memo. AMAGO is an off-policy RL algorithm derived from RED-Q/SAC.
