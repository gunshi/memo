#!/bin/bash
#SBATCH --job-name=ddppo-rl2-repeval
...
JOB_ID="small_objnav_ppo_rl2_lstm_256_hidden_4096_switch_256_update_done_not_during_rollout_fixed_eval_repevaluator_8200_eval_steps_10_evals_per_ep"
