#!/bin/bash
#SBATCH --job-name=ddppo-rl2-repeval-distrib-debug
#SBATCH --output=slurm_logs/eval/ddppo_rl2_repeps_%x_%j.out
#SBATCH --error=slurm_logs/eval/ddppo_rl2_repeps_%x_%j.err
#SBATCH --gpus a40:4
...
JOB_ID="small_objnav_ppo_rl2_lstm_256_hidden_4096_switch_256_update_done_not_during_rollout_fixed_eval_repevaluator_8200_eval_steps_100_evals_per_ep_distrib_debug"
...
srun -K python run.py --config-name lstm/smallObjNav_rl2 \
        ...
        habitat.env_task="CustomGymHabitatEnv" \
        ...
        habitat_baselines.evaluator._target_="habitat_transformers.trainer.evaluators.rl2_evaluator.RL2Evaluator" \
        ...
        habitat_baselines.vector_env_factory._target_="habitat_transformers.envs.train_il_env_factory.HabitatVectorEnvFactory" \
