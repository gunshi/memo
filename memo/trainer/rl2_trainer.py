...
class RL2Trainer(PPOTrainer):
    ...
    def _collect_environment_result(self, buffer_index: int = 0):
        ...
        with g_timer.avg_time("trainer.update_stats"):
            ...
            if self.config.habitat_baselines.rl.ppo.change_done_masks and self.config.habitat_baselines.rl.ppo.set_done_to_false_during_rollout:
            ...
            while not self.is_done():
                ...
                if self.config.habitat_baselines.call_after_update_env: 
                    ...
                    if (rollouts_count + 1) % shift_every_n_rollouts == 0:
                        ...
                        logger.info(f"Resetting env, hidden states and switching episode.")
    ...
    def _eval_checkpoint(
        ...
        self._is_distributed = False # TODO: Understand why we force set `_is_distributed` to False.
