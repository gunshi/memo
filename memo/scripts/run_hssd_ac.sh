...
srun python memo/run.py --config-name baseline/smallObjNav_transformers_base_autocomp \
        ...
        habitat_baselines.rl.policy.main_agent.transformer_config.summary_length=32 \
